    ...
    public class ConcurrentBagConverter : ConcurrentBagConverterBase
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            try
            {
                ...
                return genericMethod.Invoke(this, new [] { reader, objectType, itemType, existingValue, serializer });
            }
            ...
            where TConcurrentBag : ConcurrentBag<TItem>
        {
            ...
            if (reader.TokenType != JsonToken.StartArray)
                throw new JsonSerializationException(
                    $"Expected {JsonToken.StartArray}, encountered {reader.TokenType} at path {reader.Path}");
